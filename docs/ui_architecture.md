...
- **Next UI slice:** tighten progression surfaces without changing the reward ledger or inventing level thresholds/rewards. The manual Gate 1 field matrix remains open independently of this UI work.
