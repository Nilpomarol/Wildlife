...
- A regional guide reports two separate totals: **catalogue progress** against the frozen curated denominator and **Extra discoveries** observed in that region but absent from that catalogue version. Extra discoveries may be browsed from the guide, but never increase its denominator, completion percentage, rarity progress, Essentials or Icons.
